import { i as __toESM } from "./chunk-mMvWCSj1.js";
import { t as require_react } from "./react-DuAP9-Xf.js";
import { t as require_react_dom } from "./react-dom-DDIfM-E6.js";
import { t as require_leaflet_src } from "./leaflet-src-BHmR0nqZ.js";
...
function addClassName(element, className) {
	splitClassName(className).forEach((cls) => {
		import_leaflet_src$22.DomUtil.addClass(element, cls);
	});
}
...
const ImageOverlay = createLayerComponent(function createImageOveraly({ bounds, url, ...options }, ctx) {
...
function PaneComponent(props, forwardedRef) {
	...
	return props.children != null && paneElement != null ? /* @__PURE__ */ (0, import_react_dom$1.createPortal)(/* @__PURE__ */ import_react.createElement(LeafletProvider, { value: newContext }, props.children), paneElement) : null;
}
